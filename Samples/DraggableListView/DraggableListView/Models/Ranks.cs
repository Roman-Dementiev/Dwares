...
namespace DraggableListView.Models
{
	...
	{
		public static readonly Private Private = new Private();
		public static readonly PrivateFirstClass PrivateFirstClass = new PrivateFirstClass();
		public static readonly LanceCorporal LanceCorporal = new LanceCorporal();
		public static readonly Corporal Corporal = new Corporal();
		public static readonly Sergeant Sergeant = new Sergeant();
		public static readonly StaffSergeant StaffSergeant = new StaffSergeant();
		public static readonly GunnerySergeant GunnerySergeant = new GunnerySergeant();
		public static readonly MasterSergeant MasterSergeant = new MasterSergeant();
		public static readonly FirstSergeant FirstSergeant = new FirstSergeant();
		public static readonly MasterGunnerySergeant MasterGunnerySergeant = new MasterGunnerySergeant();
		public static readonly SergeantMajor SergeantMajor = new SergeantMajor();
		public static readonly SergeantMajorOfTheMarineCorps SergeantMajorOfTheMarineCorps = new SergeantMajorOfTheMarineCorps();
