...
//		public Task LoadInvoices(string carId) => throw new NotImplementedException();
//		public Task<string> GetProperty(string key, Car car) => throw new NotImplementedException();
//		public Task SetProperty(string name, Car car, string value) => throw new NotImplementedException();
//	}
//}
